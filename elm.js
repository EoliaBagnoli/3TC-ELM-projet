...
var $author$project$HomePage$definition = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('C\'est un mot qui veut dire bite (mais un autre)')
				])),
			A2(
			$elm$html$Html$a,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text('file:///home/eolia/Documents/ELM/index.html')
				]))
		]));
...
var $author$project$HomePage$game_body = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$placeholder('le mot est : '),
					$elm$html$Html$Attributes$type_('word')
				]),
			_List_Nil)
		]));
...
var $author$project$HomePage$main = A2(
	...
	_List_Nil,
	_List_fromArray(
		[$author$project$HomePage$header, $author$project$HomePage$definition, $author$project$HomePage$game_body, $author$project$HomePage$footer]));
